...
const FeatureSection = () => {
  const features = [
    {
      ...
      tag: "VIDEO FEEDBACK",
      description: "Easily gather authentic video feedbacks from hackathon participants and conference attendees with our User-friendly interface designed specifically for video collection.",
  ...
  return (
    <section className="py-20 px-4 lg:px-16 mt-6">
